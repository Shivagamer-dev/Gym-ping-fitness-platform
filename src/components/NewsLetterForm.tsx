...
interface NewsletterFormProps {
  onSuccess: () => void;
  hideHeading?: boolean; // NEW optional prop
}

function NewsletterForm({ onSuccess, hideHeading }: NewsletterFormProps) {
    ...
    try {
      ...
      if (error) {
        ...
        if (error.message.includes("duplicate key")) {
          // Assuming backend returns a specific message for duplicate emails
  ...
  return (
    <div>
      {/* Only show this block when hideHeading is NOT true */}
      {!hideHeading && (
        <>
