        ...
        <div className="mb-6">
            <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-gray-700/50 rounded-xl p-4 text-center">
                ...
                <div className="flex justify-center gap-3">
                    <a href="#" className="group bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-lg px-4 py-2 hover:bg-gray-700/50 transition-all flex items-center">
