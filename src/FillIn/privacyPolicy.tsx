  ...
  return (
    <div className="bg-[#1A1A1A] text-white py-10">
      <div className="p-6 max-w-3xl mx-auto">
        <h1 className="text-4xl font-extrabold text-center mb-8 italic tracking-wide">Privacy Policy</h1>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside">
            ...
            <li><strong>Location Data:</strong> For features like the gym locator, we may request permission to access your location (at least not now), which is only used to enhance your experience and is not stored by us.</li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            ...
            <Link to="/support" className="text-blue-500 underline ml-1 hover:text-blue-700 transition">Support</Link> page.
          </p>
        </section>
      </div>
    </div>
