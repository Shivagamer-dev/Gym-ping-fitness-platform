...
function About() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
      ...
      {/* Features Section */}
      <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 border-y border-gray-700/50">
        <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-300 leading-relaxed">
              Your data belongs to you. We use ncryption and never sell your personal information to third parties.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-16 text-center">
          ...
          <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-xl p-8 inline-block">
            <p className="text-lg text-blue-400 font-semibold italic">
              "Fitness isn't about being perfect. It's about being better than you were yesterday."
            </p>
